...
Current node: 12-01 slice 1 — `tadori purge` + confinement audit (CLI): IMPLEMENTED on branch bp/12-01-purge-confinement, pending CI/merge. 09-05 agent-change overlays MERGED (#43=4eebbde). 08-04 (#42). Derived-engine COMPLETE (08-07B/C/D/E).
Branch: bp/12-01-purge-confinement (off main 4eebbde)
Latest commit: 4eebbde main (PR #43 merged — 09-05 agent-change overlays, CI green both OSes; SECURITY task-scoping test passed on CI). 08-04 (#42). 08-07E (#41). 08-07D (#40). 08-07C (#39). 08-07B (#38). 08-07A (#37). 08-07 (#36). 09-04 (#35). 09-03 (#33/#34). 09-02.
Open PR: 12-01 slice 1 to be opened after push.
...
Next frontier: after 12-01 slice 1 merges — remaining 12-01 slices (retention/age-pruning of agent_events+snapshots; ignore-rule + redaction audit reusing confinedRealPath), then 11-01 (packages/bench harness; pred 00-02), and 08-11 (browser a11y / Chromium full-flow — needs a Playwright harness). Done: semantic-zoom (08-04), derived-engine (08-07B/C/D/E), agent-change overlays (09-05), purge+confinement (12-01 s1). changed_with edges surface through GET /api/v1/edges as ordinary edges (no dedicated overlay yet).
Known blocker: none
