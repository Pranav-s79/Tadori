...
Current node: 08-04 — task-region symbol expansion (viz, 3rd zoom level): IMPLEMENTED on branch bp/08-04-symbol-expansion, pending CI/merge. Derived-engine follow-ups COMPLETE (08-07B/C/D/E MERGED #38-#41). 08-07E /path parity MERGED (#41=05590a5).
Branch: bp/08-04-symbol-expansion (off main 05590a5)
Latest commit: 05590a5 main (PR #41 merged — 08-07E /path full output + parity, CI green both OSes). 08-07D (#40). 08-07C (#39). 08-07B (#38). 08-07A (#37). 08-07 (#36). 09-04 (#35). 09-03 (#33/#34). 09-02.
Open PR: 08-04 to be opened after push.
...
Next frontier: after 08-04 merges — all three semantic-zoom levels (package→file→symbol) now exist. Dependency-ready open nodes: 09-05 (agent-change review overlays; preds 08-09 observations + 09-01 review-diff both built), 12-01 (privacy & data lifecycle; pred 07-02), 11-01 (packages/bench harness; pred 00-02), and 08-11 (browser a11y / Chromium full-flow — needs a Playwright harness; validates all 08-07*/08-04 surfaces end-to-end). The derived-engine follow-ups (08-07B/C/D/E) are complete; explore displays render real data. changed_with edges surface through GET /api/v1/edges as ordinary edges (no dedicated overlay yet).
Known blocker: none
