...
|---|---|---|---|---|---|---|---|---|
| 00-01 | Repo sync & README correction | 0 | blocked (local commits `7891a99..a4ab158` built; README `tadori diff` claim blocked by 00-01A; push step deferred) | 00-01A | S | S | `blueprints/00-01-repo-sync-and-readme.md` | partial: `a4ab158` |
| 00-01A | allowJs scanner contract & regression | 0 | ready | — | S | S | `blueprints/00-01A-allowjs-scanner-contract.md` | — |
