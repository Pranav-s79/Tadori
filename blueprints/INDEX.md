...
| 08-03 | Semantic zoom: file expansion | 8 | built (2026-07-20; viz 105/105, tsc/eslint/vite build exit 0, additive expand/collapse byte-stability, edge aggregation, ref-cached re-expand; work committed on bp/08-03-semantic-zoom-files, PR to open against main) | 08-02 | S | M | `blueprints/08-03-semantic-zoom-files.md` | branch `bp/08-03-semantic-zoom-files` |
