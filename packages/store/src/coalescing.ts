...
import type { EdgeDiffRow } from "./diff.js";
 ...
 *
 * Lives in @tadori/store (alongside EdgeDiffRow/diffSnapshotEdges) so both the
 * server route and the harness fixture-04 comparison consume one implementation
 * — no harness→server dependency, no duplicate matcher.
 *
 ...
 * that pair references it as an endpoint.
 */
